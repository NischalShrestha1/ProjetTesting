...
export default function AdminPanel({ products: initialProducts, categories: initialCategories, user }) {
  ...
  const loadOrders = async () => {
    try {
      const { data } = await axios.get(`${backendUrl}/orders/admin/all`, {
  ...
  const handleProductSubmit = async (e) => {
    ...
    try {
      ...
      if (productForm._id) {
        ...
        await axios.put(`${backendUrl}/products/${productForm._id}`, productData, {
          withCredentials: true
        });
      } else {
        // Create new product
  ...
  const handleCategorySubmit = async (e) => {
    ...
    try {
      ...
      if (categoryForm._id) {
        ...
        await axios.put(`${backendUrl}/categories/${categoryForm._id}`, categoryData, {
          withCredentials: true
        });
      } else {
        // Create new category
        await axios.post(`${backendUrl}/categories`, categoryData, {
          withCredentials: true
        });
      }
  ...
  const updateUser = async (id, userData) => {
    try {
      await axios.put(`${backendUrl}/users/${id}`, userData, {
        withCredentials: true
      });
