...
if($usermail == true){
  ...
  header("location: http://localhost/Project_I/index.php");
}
...
<body>
    ...
    <nav class="sidenav">
        <ul>
            <li class="pagebtn active"><img src="../Images/icon/dashboard.png">&nbsp&nbsp&nbsp Dashboard</li>
